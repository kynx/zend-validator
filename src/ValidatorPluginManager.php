...
class ValidatorPluginManager extends AbstractPluginManager
{
    ...
    protected $factories = [
        ...
        'zendinvalidatoralnum'                => InvokableFactory::class,
        'zendinvalidatoralpha'                => InvokableFactory::class,
        'zendinvalidatordatetime'             => InvokableFactory::class,
        'zendinvalidatorisfloat'              => InvokableFactory::class,
        'zendinvalidatorisint'                => InvokableFactory::class,
        'zendinvalidatorphonenumber'          => InvokableFactory::class,
        'zendinvalidatorpostcode'             => InvokableFactory::class,
        'zendvalidatorbarcode'                => InvokableFactory::class,
        'zendvalidatorbarcodecode'            => InvokableFactory::class,
        'zendvalidatorbarcodecodeext'         => InvokableFactory::class,
        'zendvalidatorbarcodecodeinterleaved' => InvokableFactory::class,
        'zendvalidatorbarcodeean'             => InvokableFactory::class,
        'zendvalidatorbarcodegtin'            => InvokableFactory::class,
        ...
        'zendvalidatorbarcodeitf'             => InvokableFactory::class,
        ...
        'zendvalidatorfilecrc'                => InvokableFactory::class,
